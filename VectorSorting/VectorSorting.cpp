...
void quickSort(vector<Bid>& bids, int begin, int end) {
	...
	// call quicksort using midpoint value (begin to midpoint)
	quickSort(bids, begin, mid);

	// call quicksort using midpoint value (mid + 1 to end)
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 3:
                    ...
                    // Complete the method call to load the bids
                    selectionSort(bids, bids.size());

                    //display selection sort bids
                    //enhancement made by Taylor Cruz on 1/27/2022
                    for (i = 0; i < bids.size(); ++i) {
                        cout << bids[i] << " bids read" << endl;
                    }
        ...
        case 4:
                  ...
                  //Display the quicksort bids 
                  //enahncement made on 1/27/2022 by Taylor Cruz
                  for (i = 0; i < bids.size(); ++i) {
                      cout << bids[i] << " bids read" << endl;
                  }
